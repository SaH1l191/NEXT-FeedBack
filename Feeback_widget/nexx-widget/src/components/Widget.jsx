...
export const Widget = ({ projectId }) => {
  ...
  const submit = async (e) => {
    ...
    const data = {
      ...
      p_user_name: e.target.name.value,
      p_user_email: e.target.email.value,
      p_message: e.target.feedback.value,
      p_rating: rating,
    };
    console.log("data from form",data)
    // rpc to call db function 
        ...
        <Popover>
          ...
          <PopoverContent className="widget rounded-lg bg-card p-4 shadpw-lg w-full max-w-md">
            ...
            <div className="text-gray-600">
              Powered by{" "}
              <a
                href="https://nextFeedback.vercel.app/"
                target="_blank"
